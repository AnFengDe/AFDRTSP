...
typedef void (STD_CALLBACK *AFD_RTSP_Handle_Cmd_SETUP)(unsigned int sessionid, const char* url, const unsigned short rtp_client_port, unsigned short *rtp_server_port);
