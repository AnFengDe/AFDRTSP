...
typedef void (afterGettingData)(unsigned char const *clientData, unsigned frameSize, 
									struct timeval presentationTime,char *outFileName,void*); //zhaojin
...
public:
  ...
  void afterGetingFrameData(afterGettingData *afterGetFunc,char *outFileName); //zhaojin
...
private: // redefined virtual functions:
  ...
  afterGettingData *fAfterGetFunc;//Callback function, zhaojin
};
