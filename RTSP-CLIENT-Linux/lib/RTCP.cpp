...
RTCPInstance::RTCPInstance(UsageEnvironment& env, Groupsock* RTCPgs,
  ...
  : Medium(env), fRTCPInterface(this, RTCPgs), fTotSessionBW(totSessionBW),
	...
	fBYEBYEHandlerTask(NULL), fBYEBYEHandlerClientData(NULL),
...
void RTCPInstance::setBYEBYEHandler(TaskFunc* handlerTask, void* clientData,
								 Boolean handleActiveParticipantsOnly) {
									 fBYEBYEHandlerTask = handlerTask;
									 fBYEBYEHandlerClientData = clientData;
									 fByeHandleActiveParticipantsOnly = handleActiveParticipantsOnly;
}
	...
	// ClientInterface::RtcpStatus("RR");
...
#endif
#if 0
	  ClientInterface::RtcpStatus("BYE");
#endif
	  ...
	  if (byeHandler != NULL
	    ...
	    (*byeHandler)(fByeHandlerClientData);
			if (fBYEBYEHandlerTask != NULL) (*fBYEBYEHandlerTask)(fRRHandlerClientData);
	  }
